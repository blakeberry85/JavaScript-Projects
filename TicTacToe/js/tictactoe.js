...
function checkWinCon2(info,squareArray) {
    ...
    // iterate through the growing array during
    // gametime searching for the existence of
    // index 3, index 4 and index 5 and once
    // they do appear in the array, record their
    // avatars and compare all 3 for win cons
    for (var i in info) {
    ...
    winner(winDetected,winCon2); // winCon1 is the array of win combo
}
...
function checkWinCon3(info,squareArray) {
    ...
    // iterate through the growing array during
    // gametime searching for the existence of
    // index 6, index 7 and index 8 and once
    // they do appear in the array, record their
    // avatars and compare all 3 for win cons
    for (var i in info) {
    ...
    winner(winDetected,winCon3); // winCon1 is the array of win combo
}
...
function checkWinCon4(info,squareArray) {
    ...
    // iterate through the growing array during
    // gametime searching for the existence of
    // index 0, index 3 and index 6 and once
    // they do appear in the array, record their
    // avatars and compare all 3 for win cons
    for (var i in info) {
        if (info[i].charAt(0) == "0") {
...
function checkWinCon5(info,squareArray) {
    ...
    // iterate through the growing array during
    // gametime searching for the existence of
    // index 1, index 4 and index 7 and once
    // they do appear in the array, record their
    // avatars and compare all 3 for win cons
    for (var i in info) {
        if (info[i].charAt(0) == "1") {
...
function checkWinCon6(info,squareArray) {
    ...
    // iterate through the growing array during
    // gametime searching for the existence of
    // index 2, index 5 and index 8 and once
    // they do appear in the array, record their
    // avatars and compare all 3 for win cons
    for (var i in info) {
        if (info[i].charAt(0) == "2") {
...
function checkWinCon7(info,squareArray) {
    ...
    // iterate through the growing array during
    // gametime searching for the existence of
    // index 0, index 4 and index 8 and once
    // they do appear in the array, record their
    // avatars and compare all 3 for win cons
    for (var i in info) {
        if (info[i].charAt(0) == "0") {
...
function checkWinCon8(info,squareArray) {
    ...
    // iterate through the growing array during
    // gametime searching for the existence of
    // index 2, index 4 and index 6 and once
    // they do appear in the array, record their
    // avatars and compare all 3 for win cons
    for (var i in info) {
        if (info[i].charAt(0) == "2") {
